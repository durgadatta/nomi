...
def test_underscore_loop_target_binds_like_regular_name(interpreter_mode):
    run = get_run_eval_loop(interpreter_mode)
...
def test_underscore_match_wildcard_does_not_rebind(interpreter_mode):
    run = get_run_eval_loop(interpreter_mode)
...
def test_double_underscore_match_capture_binds(interpreter_mode):
    run = get_run_eval_loop(interpreter_mode)
