...
review of the primary set plus the high-impact evolution paths: data as shape,
patterns as choice, absence/result as non-success, resources as world contact,
