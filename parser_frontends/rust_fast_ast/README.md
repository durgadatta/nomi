...
```bash
cargo run --quiet \
  --manifest-path parser_frontends/rust_fast_ast/Cargo.toml \
...
cargo run --quiet --manifest-path parser_frontends/rust_fast_ast/Cargo.toml -- ast-json /private/tmp/nomi-rust-slice.nomi
```
